...
namespace VoxelBusters.ReplayKit.Common.Utility
{
    public partial class AndroidManifestGenerator
    {
        ...
        protected void WriteService(XmlWriter _xmlWriter, string _name, string _foregroundServiceType, bool _enabled, string _comment = null)
        {
            if (_comment != null)
                _xmlWriter.WriteComment(_comment);
            ...
            {
                WriteAttributeString(_xmlWriter, "android", "name", null, _name);
                WriteAttributeString(_xmlWriter, "android", "enabled", null, _enabled ? "true" : "false");
                WriteAttributeString(_xmlWriter, "android", "foregroundServiceType", null, _foregroundServiceType);
            }
            _xmlWriter.WriteEndElement();
        }
